...
class Conv2d(nn.Module):
    ...
    Furthermore, the linear combination is implemented using a group-shuffle
    convolution, reducing the number of parameters.
    ...
    def __init__(self,
        ...
        if kernel_size == 1:
            ...
            self.conv = nn.Sequential(
                ...
                shuffle.Conv2d(in_channels=in_channels * depth_multiplier,
                               out_channels=out_channels,
                               kernel_size=1,
                               stride=1,
                               padding=0,
